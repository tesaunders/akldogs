...
#'
#' Data compiled by Auckland Council's Animal Management division relating to registered dogs in Auckland for financial years 2021-2025.
#'
...
#' \item{owner_classification_desc}{Whether the owner is subject to a classification under the Dog Control Act.}
#' \item{animal_registration_group}{Animal registration group.}
#' \item{animal_gender_description}{Sex of the animal.}
